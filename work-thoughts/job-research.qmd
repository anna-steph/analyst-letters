...
Depending on the breadth of your search, consider how you might research specific positions, organizations, and/or career trajectories.
...
-   Which particular skills are necessary to get in the door at Job<sub>t=1</sub>? If asked, how might you demonstrate those skills?\
...
-   Look two jobs down the line: what skills, experiences, and accomplishments do you need out of Job<sub>t=1</sub> (2-3 years out) to prepare you for Job<sub>t=2</sub> (3-5 years out)?

---

### Researching organizations

When beginning a more wide-ranging job search, start with a list of at least 20 organizations of interest. You may have an initial list of places in mind, but push yourself beyond your shortlist.
...
-   What are the trajectories of the people who are there now and were there in the recent past? What skills and experiences did they have before joining? What skills do they use now?\
...
If you feel very uncertain where to begin, it may be useful to first identify jobs you aspire towards, then work backwards to reverse engineer a path there. For this, find 20 people doing cool things 2-5 years out from where you are (one or two jobs out). Search for folks who have current, relevant career information, but can also put their position into perspective.

Go for a "Goldilocks" time window relative to your circumstances. Too far out, and their advice might not be current or applicable to you. Too close, and they might not have enough perspective and the benefit of hindsight.\
...
-   How have they seen their role and their organization's needs evolve over the last year? How might they evolve over the coming year?\
...
Remember to follow up to thank folks for their time. If you implement their advice, tell them so.

Don't be discouraged if the people you reach out to don't respond immediately, or at all. Everyone's busy juggling multiple demands on their time. A one-in-five response rate is still a good response rate!
